...
def validate_pattern_input(text: str, /) -> str | None:
    """
    ...
    while True:
        inp = input(text)
        if inp.isprintable() and is_valid_regex(inp):
            result = inp
        return result
...
def validate_int_with_exit_input(text: str, min_value: int, max_value: int, /) -> str:
    """
    Asks the user for input using the given prompt text.
...
def validate_yesno_with_exit_input(text: str, /) -> str:
    """
    Asks the user for input using the given prompt text.
...
def validate_yesno_input(text: str, /) -> str:
    """
    Asks the user for input using the given prompt text.
