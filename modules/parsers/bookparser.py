...
class BookParser:
    ...
    def get_basic_book_stats(self, book: dict[str, Any], content: str, line_count: int, /) -> dict[str, Any]:
        """
    ...
    def get_book_info(self, book: dict[str, Any], /) -> dict[str, Any]:
        """
        ...
        return self.get_basic_book_stats(book, content, line_count)


    def get_book_info_with_regex(self, book: dict[str, Any], regex: str, /) -> dict[str, Any]:
        """
        ...
        """
        content, line_count = self.read_file_and_count_lines(book["File"])
        result = self.get_basic_book_stats(book, content, line_count)
        result["MatchCount"] = len(re.findall(regex, content))
        return result


    def get_books(self, directory: str, /) -> list[dict[str, Any]]:
        """
